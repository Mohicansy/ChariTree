const mainnetContract = "0x4e63CF0249401273B388D16F5A13Dc1345575777";
...
async function mint() {
  ...
  var amountOfMoney = document.getElementById("amount").value;
  amountOfMoney = Number(amountOfMoney) * 1000000000000000000;
  console.log(amountOfMoney);
  var web3 = new Web3(Web3.givenProvider);
  var contract = await new web3.eth.Contract(mainnetAbi, mainnetContract);
  var myAccountAddress = (await this.getAccounts())[0];
  try {
    await contract.methods.mint(1).send(
      {from:myAccountAddress, value:amountOfMoney.toString()},function(error, transactionHash){
